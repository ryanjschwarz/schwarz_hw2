...
class WiCDataset(Dataset):
    ...
    def __init__(self, identifier):
        self.dataset = pd.read_table("WiC_dataset/"+identifier+"/"+identifier+".data.txt",header=None)
        self.identifier = identifier
        self.labels = ""
        if identifier not in ['test']:
            self.labels = pd.read_table("WiC_dataset/"+identifier+"/"+identifier+".gold.txt",header=None)
        pass
